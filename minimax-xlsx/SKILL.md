...
triggers: minimax-xlsx, Excel, spreadsheet, xlsx, .xlsx, .csv, .tsv, pivot table, financial model, formula, tabular data, create spreadsheet, edit xlsx, read Excel, validate spreadsheet
license: MIT
metadata:
  version: "1.0"
