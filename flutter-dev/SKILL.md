...
triggers: flutter-dev, flutter, Flutter, Dart, Riverpod, Bloc, GoRouter, flutter widget, flutter app, cross-platform flutter, pubspec.yaml, flutter test, flutter build
license: MIT
metadata:
  version: "1.0.0"
  category: mobile
